...
public class DoTAbility extends SpecialAbility {
    private DamageEffect damage;

    public DoTAbility(Hero origin, Hero target, String preciseOrigin, boolean isBuff, boolean isRemovable, int timer, String name, int stacks,
